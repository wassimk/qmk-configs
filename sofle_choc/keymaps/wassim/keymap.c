 ...
 */
    ...
    [_LAYER3] = LAYOUT(KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
                       KC_TRNS, KC_INS, KC_PSCR, KC_APP, KC_NO, KC_PGUP, KC_NO, LALT(KC_B), KC_NO, LALT(KC_F), G(KC_D), KC_NO,
                       KC_TRNS, KC_LALT, KC_LCTL, KC_LSFT, KC_CAPS, KC_PGDN, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_DEL, KC_BSPC,
